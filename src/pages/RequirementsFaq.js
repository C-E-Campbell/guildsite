...
"
      ...
      <FaqQuestion
        ...
        answer="There are a couple of members with Alpha-1 access, few members that will have Alpha-2 access, and a decent amount of out members will have beta access. While access is not required to join, we are hoping to have 40-60%/+ of our members active in the beta. We will also have several people dedicated to streaming Alpha / Beta for our members to watch & learn from.
"
      />
      <FaqQuestion
        question="Will we be active before the release of Ashes of Creation?"
        answer="Yes, keep reading. But also ~ We don’t want to just be a reservation spot for you, although we can be. But we want you to be invested in reserving your spot *and* playing to grow with us. If we have synergy on launch, we will kick ass. More on this in the Launch-Plans Topic Q&A.
"
      />
      <FaqQuestion
